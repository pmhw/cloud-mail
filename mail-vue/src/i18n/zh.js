const zh = {
    ...
    emailList: '邮件列表',
    collapseEmailList: '折叠邮件列表',
    expandEmailList: '展开邮件列表',
    recipient: '收件人',
    cc: '抄送',
    bcc: '密送',
    forwardMail: '转发的邮件',
    emailSignature: '邮件签名',
    emailSignatureDesc: '签名会直接插入邮件正文；新建/回复与转发可分别设置',
    newMailSignature: '新建/回复签名',
    forwardMailSignature: '转发签名',
    ...
    oss: '对象存储',
    osDomain: '访问域名',
    ossDomainDesc: '附件/图片的公网下载域名。接京东云/S3 时填桶公网域名或 CDN 域名，浏览器会直连对象存储；用 KV 时不要填',
    emailPush: '邮件推送',
    tgBot: 'Telegram 机器人',
    disable: '关闭',
    disabled: '已关闭',
    ...
    addOsDomain: '添加域名',
    domainDesc: '例如 your-bucket.s3.cn-north-1.jdcloud-oss.com',
    ...
    send: '发送',
    scheduleSend: '定时发送',
    scheduleSendTime: '选择发送时间',
    scheduleSendTip: '时间按本地时区选择，将在服务器到点后自动发送（最长30天）',
    scheduling: '正在设置定时发送',
    scheduleSuccessMsg: '已设置定时发送',
    scheduleFailMsg: '定时发送设置失败',
    emptyScheduleTimeMsg: '请选择定时发送时间',
    scheduleTimeTooSoon: '定时发送时间至少需要晚于当前1分钟',
    scheduled: '定时发送',
    scheduledAtTip: '将于 {time} 自动发送',
    cancelSchedule: '取消定时',
    cancelScheduleConfirm: '确认取消该定时发送吗？',
    ...
    s3ConfigurationDesc: '兼容 S3 的对象存储（京东云 OSS、MinIO、AWS S3 等）。配好后上传走 S3，下载走上方访问域名',
    confirmDeletionOfContacts: '确认清除这些联系人吗？',
    recentContacts: '最近联系人',
    selectContacts: '选中',
    forcePathStyleDesc: '路径样式访问。京东云 OSS、部分自建存储建议打开',
    storageType: '存储类型',
    ...
    spamFilter: '垃圾邮件过滤',
    spamFilterDesc: '匹配规则的邮件会收入垃圾箱，不会拒收',
    spamFromDesc: '发件人邮箱或域名',
    spamSubjectDesc: '邮件标题',
    markAsSpam: '移至垃圾箱',
    markAsNotSpam: '移出垃圾箱',
    setSuccess: '设置成功',
    details: '详情',
