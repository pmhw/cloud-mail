const en = {
    ...
    emailList: 'Mail list',
    collapseEmailList: 'Collapse mail list',
    expandEmailList: 'Expand mail list',
    recipient: 'To',
    cc: 'Cc',
    bcc: 'Bcc',
    forwardMail: 'Forwarded message',
    emailSignature: 'Email Signature',
    emailSignatureDesc: 'Signatures are inserted into the email body. New/reply and forward can be set separately.',
    newMailSignature: 'New / Reply',
    forwardMailSignature: 'Forward',
    ...
    oss: 'Object Storage',
    osDomain: 'Domain',
    ossDomainDesc: 'Public download domain for attachments/images. For JD Cloud/S3, set the bucket public domain or CDN domain so browsers download directly. Leave empty for KV.',
    ...
    domainDesc: 'e.g. your-bucket.s3.cn-north-1.jdcloud-oss.com',
    ...
    scheduleSendTime: 'Pick send time',
    scheduleSendTip: 'Time uses your local timezone and will send automatically (up to 30 days)',
    ...
    scheduleTimeTooSoon: 'Schedule time must be at least 1 minute from now',
    scheduled: 'Scheduled',
    scheduledAtTip: 'Will send at {time}',
    cancelSchedule: 'Cancel schedule',
    cancelScheduleConfirm: 'Cancel this scheduled email?',
    ...
    s3ConfigurationDesc: 'S3-compatible storage (JD Cloud OSS, MinIO, AWS S3, etc.). Uploads go to S3; downloads use the domain above.',
    confirmDeletionOfContacts: 'Confirm clearing contacts?',
    recentContacts: 'Recent contacts',
    selectContacts: 'Select',
    forcePathStyleDesc: 'Path-style access. Recommended for JD Cloud OSS and some self-hosted storages',
    ...
    spamFilterDesc: 'Matched emails go to Spam instead of being rejected',
    spamFromDesc: 'Sender or domain',
    spamSubjectDesc: 'Subject',
    markAsSpam: 'Move to Spam',
    markAsNotSpam: 'Not Spam',
